...
def run_weekly_scrapers():
    print("=" * 100)
    print(f"[{datetime.now()}] WEEKLY SCRAPER JOB START")
    print("=" * 100)
    ...
    print(f"[{datetime.now()}] WEEKLY SCRAPER JOB END")

# ======================================================
# Main (무조건 daemon)
# ======================================================
if __name__ == "__main__":
    print("🚀 WEEKLY SCRAPER DAEMON START")
    ...
    scheduler.add_job(
        ...
        hour=5,
        minute=0,
        id="weekly_sunday_scraper",
        replace_existing=True,
        max_instances=1,
        coalesce=True,
    )

    print("⏰ Scheduler started (EVERY SUNDAY 05:00)")
    scheduler.start()
