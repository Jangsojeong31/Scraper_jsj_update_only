...
def extract_data_from_text(text: str) -> Tuple[str, str, str]:
    ...
    revision_patterns = [
        ...
        # 날짜 뒤에 바로 개정이 오는 형식 (공백 없음)
        r"(\d{4})\.(\d{1,2})\.(\d{1,2})\.?[_\s]*별\s*표\s*개\s*정",                     # 2024.6.10._별표개정(12차)
        r"(\d{4})\.(\d{1,2})\.(\d{1,2})\.?개\s*정",                                     # 2020.4.23.개정
        r"(\d{4})\.(\d{1,2})\.(\d{1,2})[_]개\s*정",                                     # 2024.7.12_개정
        r"(\d{4})\.(\d{1,2})\.(\d{1,2})\.?[_\s]+개\s*정",                               # 2024.7.12_ 개정
        
        # 2자리 연도 형식
        r"(\d{2})\.(\d{1,2})\.(\d{1,2})\.?[_\s]*별\s*표\s*개\s*정",                     # 24.6.10._별표개정
        r"(\d{2})\.(\d{1,2})\.(\d{1,2})\.?개\s*정",                                     # 20.4.23.개정
        r"(\d{2})\.(\d{1,2})\.(\d{1,2})[_]개\s*정",                                     # 24.7.12_개정
        r"(\d{2})\.(\d{1,2})\.(\d{1,2})\.?[_\s]+개\s*정",                               # 21.12.30._개정
        
        # 개정이 먼저 오고 날짜가 뒤에 오는 형식
        r"개\s*정\s*[_\s]+(\d{4})\.(\d{1,2})\.(\d{1,2})",                               # 개정_2024.10.21.
        r"개\s*정\s*[_\s]+(\d{2})\.(\d{1,2})\.(\d{1,2})",                               # 개정_22.10.21.
    ]
...
def extract_dates_from_filename(filename: str) -> Tuple[str, str]:
    ...
    revision_filename_patterns = [
        ...
        # 괄호 없이 날짜 뒤에 개정이 오는 형식 (4자리 연도)
        r"(\d{4})\.(\d{1,2})\.(\d{1,2})\.?[_\s]*별\s*표\s*개\s*정",  # 2024.6.10._별표개정(12차)
        r"(\d{4})\.(\d{1,2})\.(\d{1,2})\.?개\s*정",  # 2020.4.23.개정
        r"(\d{4})\.(\d{1,2})\.(\d{1,2})[_]개\s*정",  # 2024.7.12_개정
        r"(\d{4})\.(\d{1,2})\.(\d{1,2})\.?[_\s]+개\s*정",  # 2024.7.12_ 개정
        
        # 괄호 없이 날짜 뒤에 개정이 오는 형식 (2자리 연도)
        r"(\d{2})\.(\d{1,2})\.(\d{1,2})\.?[_\s]*별\s*표\s*개\s*정",  # 24.6.10._별표개정
        r"(\d{2})\.(\d{1,2})\.(\d{1,2})\.?개\s*정",  # 20.4.23.개정
        r"(\d{2})\.(\d{1,2})\.(\d{1,2})[_]개\s*정",  # 24.7.12_개정
        r"(\d{2})\.(\d{1,2})\.(\d{1,2})\.?[_\s]+개\s*정",  # 21.12.30._ 개정, 21.12.30._개정
