...
from FSS_Sanctions_Scraper.ocr_extractor import OCRExtractor

# OCR 후처리 모듈 import
#from post_process_ocr import process_ocr_text
from FSS_Sanctions_Scraper.post_process_ocr import process_ocr_text
...
#    format_date_to_iso
#)
from FSS_Sanctions_Scraper.extract_metadata import (
    extract_metadata_from_content,
    extract_sanction_details,
    extract_incidents,
    format_date_to_iso
...
def fss_sanctions_check() -> dict:
    ...
    try:
        ...
        # 스크래퍼 객체 생성
        # ===============================
#        from fss_sanctions_scraper_v2 import FSSScraperV2
        ...
        content, doc_type, file_url = scraper.extract_attachment_content(detail_url, first_item.get('_link_text', ''))
