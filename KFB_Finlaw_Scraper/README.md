...
은행연합회의 금융관련법규 정보를 수집하는 스크래퍼입니다.

## 개요

**URL**: https://www.kfb.or.kr/publicdata/data_finlaw.php

은행연합회에서 제공하는 금융관련법규 정보를 수집합니다.
...
# 또는 KFB_Finlaw_Scraper 디렉토리에서 실행
cd KFB_Finlaw_Scraper
python3 kfb_finlaw_scraper.py
```
...
- `output/kfb_finlaw.json`: JSON 형식 결과
- `output/kfb_finlaw.csv`: CSV 형식 결과
